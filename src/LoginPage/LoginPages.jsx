// Imports
import { useNavigate, Link, replace, redirect} from "react-router-dom";
...
export function LoginPage({ LoginStatus, setLoginStatus, setUsername }) {
...
export function Settings({username, LoginStatus}) {
  const navigate = useNavigate();
  ...
  async function RemoveAccount(deleteAccountUser) {
    console.log(deleteAccountUser)
    ...
    const response = await fetch("http://127.0.0.1:5000/delete", {
      ...
      body: JSON.stringify({ username: deleteAccountUser })  // Converts { } to JSON formatting
    })
      ...
      <div className="Backdrop">
        ...
        <div className="center">
          ...
          <div className="Code">
            ...
            <input id="code" type="password" disabled={true} value={"6804207484"}></input>
            <button onClick={() => document.getElementById("code").type = "Text"}>Show Code</button>
          </div>
